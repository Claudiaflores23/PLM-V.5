...
class master_register:    
    def __init__(self):
        ...
        self.flechistras = utl.leer_imagen("recursos_img/flezquierda.png",(35,35))
        ...
        fle_tras = Button(self.ventana, image=self.flechistras, bg="white", activebackground="white", bd=0,command=self.volver)
        fle_tras.place(x=5,y=5)
        ...
        def on_leave(e):
            ...
            if name == "":
                pass_entry_two.config(show="")
                pass_entry_two.insert(0,'Confirm password')
